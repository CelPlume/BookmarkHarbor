...
<img src="public/favicon.svg" alt="书签浏览器图标" width="96" height="96" />
...
书签浏览器以文件管理器的方式管理你的书签：它使用文件夹、选择、拖拽排序和标准编辑快捷键，让你无需学习新的操作习惯就能整理大型书签库。所有数据都保存在浏览器的 LocalStorage 中，不会发送到任何服务器，从而保证书签收藏的隐私与离线可用。
